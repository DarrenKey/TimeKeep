...
// Modifications Copyright 2019 Darren Key
/*
import UIKit
import SwiftCharts
...
struct ExamplesDefaults {
    ...
    /*static var labelSettings: ChartLabelSettings {
        return ChartLabelSettings(font: chartSettings.labelFont)
    }*/
    
    /*static var labelFont: UIFont {
        return chartSettings.fontWithSize(Env.iPad ? 14 : 11)
    }
    
    static var labelFontSmall: UIFont {
        return chartSettings.fontWithSize(Env.iPad ? 12 : 10)
    }
