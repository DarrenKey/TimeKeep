                    ...
                    else
                    {
                        ...
                        for index in 0 ..< Int(ceil(Double(dataSet.entryCount) * animator.phaseX))
                        {
                            ...
                            else
                            {
                                ...
                                /*
                                 -------------------------------------------------- this is the section i should be focusing on
                                 */
                                let vals = vals!
                                ...
                                for k in 0 ..< transformed.count
                                {
                                    ...
                                    if k == 0{
                                        delegate?.showValue(yVal: transformed[k].y, xVal: rect.origin.x, width: rect.size.width, prevValue: 0,stringValue: formatter.stringForValue(vals[k], entry: e, dataSetIndex: dataSetIndex, viewPortHandler: viewPortHandler))
                                    }
                                    else{
                                        delegate?.showValue(yVal: transformed[k].y, xVal: rect.origin.x, width: rect.size.width, prevValue: transformed[k-1].y,stringValue: formatter.stringForValue(vals[k], entry: e, dataSetIndex: dataSetIndex, viewPortHandler: viewPortHandler))
                                    }
                                }
                            }
